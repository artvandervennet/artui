    ...
    <main className="relative flex min-h-screen flex-col text-fd-foreground">
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, transparent, var(--color-fd-background))",
          }}
        />
      </div>
      ...
      <header className="mx-auto w-full max-w-5xl px-6 pb-12 pt-24 sm:pt-32">
        ...
        <h1 className="text-balance text-5xl font-semibold tracking-tight sm:text-6xl">
          ...
          <span className="text-fd-primary">compile&nbsp;error</span>.
        </h1>
        <p className="mt-6 max-w-2xl text-pretty text-lg text-fd-muted-foreground sm:text-xl">
          Components that refuse to render inaccessibly. Copied into your repo,
      ...
      <section className="mx-auto w-full max-w-5xl px-6 py-16">
        <p className="text-balance text-2xl font-medium tracking-tight sm:text-3xl">
          ...
          found WCAG violations on{" "}
          <span className="text-fd-primary">95.9%</span> of the top one million
          homepages.
        </p>
        <p className="mt-4 max-w-2xl text-base text-fd-muted-foreground">
          The same six categories show up every year: missing alt text,
          unlabelled inputs, empty buttons, low contrast. A library can prevent
          them.
        </p>
      </section>
      ...
      <section className="mx-auto w-full max-w-5xl px-6 py-12">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2">
          ...
          <article className="rounded-lg border border-fd-border bg-fd-card p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-fd-muted-foreground">
              Whatever the type system cannot express surfaces as a red
              development overlay and a{" "}
              <code className="rounded bg-fd-muted px-1.5 py-0.5 text-[0.85em] text-fd-foreground">
                console.error
              </code>
              . Both layers are no-ops in production. Shipping is silent.
              Development is noisy on purpose.
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="mx-auto w-full max-w-5xl px-6 py-12">
        ...
        <p className="mt-3 max-w-2xl text-lg text-fd-foreground">
          artui has no runtime package. The CLI copies component source into
          your repo.
        </p>
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          <article className="rounded-lg border border-fd-border bg-fd-card p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-fd-muted-foreground">
              The dev overlay says exactly what triggered it. You can read,
              modify, and own every file.
            </p>
          </article>
          <article className="rounded-lg border border-fd-border bg-fd-card p-6">
            <h3 className="text-base font-semibold text-fd-foreground">
          ...
          <article className="rounded-lg border border-fd-border bg-fd-card p-6">
            ...
            <p className="mt-2 text-sm leading-relaxed text-fd-muted-foreground">
              You import what is in your repo, full stop. No barrel files, no
              surprise transitive bundles.
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="mx-auto w-full max-w-5xl px-6 py-12">
        ...
        <ul className="mt-6 space-y-3 text-base text-fd-muted-foreground">
          <li>
            <span className="text-fd-foreground">Not a design system.</span>{" "}
            Components ship minimal styles you are expected to rebrand. The
            accessibility behaviour, not the visual language, is the product.
          </li>
          <li>
            <span className="text-fd-foreground">
              Not a replacement for testing.
            </span>{" "}
            Type-level enforcement catches the static mistakes; manual
            screen-reader testing and automated axe runs catch the rest.
          </li>
          <li>
            <span className="text-fd-foreground">
              Not a complete component library.
            </span>{" "}
            Coverage grows as accessible patterns are validated. Missing a
            primitive?{" "}
            <a
