...
export const meta: ComponentMeta = {
  ...
  props: [
    ...
    },
    {
      ...
      type: 'Date | null',
      required: true,
      description: 'The currently selected date, or null when no date is selected.',
    },
    {
      name: 'onChange',
      type: '(next: Date | null) => void',
      required: true,
      description: 'Called when the user selects a date via the calendar or types a valid date.',
    },
    {
      name: 'locale',
      type: 'string',
...
/>`,
    ...
    {
      name: 'nl-BE locale',
      description: 'Belgian Dutch locale with DD/MM/YYYY format and Monday week start.',
